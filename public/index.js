    ...
    try {
      ...
      if (response.ok) {
        ...
        responseDiv.innerHTML = `
                ...
                <p><strong>Failed Emails:</strong> ${
                  failedEmails.length > 0 ? failedEmails : "None"
                }</p>
                <p><strong>Invalid Emails:</strong> ${
                  invalidEmails.length > 0 ? invalidEmails : "None"
                }</p>
            `;
      ...
      const responseDiv = document.getElementById("response");
      responseDiv.innerHTML =
        "<p>Error sending emails. Please try again later.</p>";
      responseDiv.style.color = "red";
    }
  });
